...
def our(model, forget_loader, forget_text_loader, forget_indices, retain_loader, retain_text_loader, retain_indices, sampled_forget_loader, args):
    ...
    if getattr(args, "use_masked_rmisu", False):
        ...
        config = MaskedRMisUConfig(
            ...
            p_probe_path=args.masked_rmisu_p_probe,
            alpha=args.rmu_alpha,
            beta=args.rmu_beta,
            probe_beta=args.masked_rmisu_probe_beta,
            ...
            preference_positive_alpha=args.masked_rmisu_preference_positive_alpha,
            bounded_delta_l2_alpha=args.masked_rmisu_bounded_delta_l2_alpha,
            ...
            probe_steering_coeff=args.masked_rmisu_probe_steering_coeff,
            probe_coeffs=args.masked_rmisu_probe_coeffs,
